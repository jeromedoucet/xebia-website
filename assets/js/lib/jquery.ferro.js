    		...
    		ferroSliderDesktop : function(options) { 
    			...
    			function clickEvent(event,$el){
    		 	...
    		 	function createPlayer(dspPlayer){
    		 		...
    		 		$(elementToTrigger).append("<div id='slidingSpacesPlayer'><div id='slidingSpacesPlayerPrev'><img src='../lab/jQueryPlugins/ferroSlider/v/1.2/img/prev_"+suffixPlayer+".png' alt=''/></div><div id='slidingSpacesPlayerPlayPause' class='"+autoPlayClass+"'><img src='../lab/jQueryPlugins/ferroSlider/v/1.2/img/pause_"+suffixPlayer+".png' alt=''/></div><div id='slidingSpacesPlayerNext'><img src='../lab/jQueryPlugins/ferroSlider/v/1.2/img/next_"+suffixPlayer+".png' alt=''/></div></div>");
