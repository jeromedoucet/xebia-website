window.TECHTRENDS = [
    {
        file: 'techtrends-xebia.pdf',
        packshot:'packshot.png',
        date: '04/2013',
        summary: [
            {
                title: 'FOCUS SUR BIG DATA',
                content: [
                    ...
                    "Le champion : Hadoop",
                    "Les challengers complémentaires",
                    "Les champs d'application"
                ]
            },
            {
                title: 'Egalement dans ce numéro...',
                content: [
                    "Les Applications Web d'entreprise en 2013",
                    "Cloud Computing",
                    "Programmation fonctionnelle",
                    "Les stratégies d'entrée sur le marché mobile",
    ...
    {
        file: 'techtrends-xebia-devops.pdf',
        packshot:'packshot-devops.png',
        date: '11/2013',
        summary: [
            {
                title: 'Coopérer',
        ...
        description: {
            title: 'FOCUS SUR DEVOPS',
            content: "De l'équipe Scrum à la Feature Team, les transformations agiles ont convaincu de nombreuses directions de SI par leur efficacité au sein des équipes de développement. L'agilité, quand elle n'est appliquée qu’au développement, se trouve néanmoins freinée par les tâches d'exploitation qui surviennent aprés chaque livraison. Le but du mouvement DevOps est d’abattre cette frontière en créant une synergie entre les équipes d'exploitation (Ops) et les équipes de développement (Devs). Dans ce numéro, nous allons vous guider dans notre vision d'une démarche d’amélioration, pour pallier ces problèmes efficacement, afin que “DevOps” ne soit pas un buzzword supplémentaire pour vous."
        }
    },
    {
        file: 'techtrends-xebia-agile.pdf',
        date: '04/2014',
        packshot:'packshot-agile.png',
        summary: [
            {
                title: 'IMAGINER',
                content: [
                    "La professionnalisation du métier de Product Owner",
                    "Intégrez le Product Owner comme un poste à part entière",
                    "Ouvrez-vous à des pratiques, outils et disciplines périphériques",
                    "Créez un management de produit Agile"
                ]
            },
            {
                title: 'RÉALISER',
                content: [
                    "L'émergence de Kanban",
                    "Feature Teams",
                    "Etes-vous prêt pour le modèle Spotify",
                    "Transformations Agiles à grande échelle"
                ]
            ...
            },
            {
                title: 'MESURER',
                content: [
                    "Intégrez la notion de prédictibilité",
                    "Indicateurs"
                ]
            }
        ],
        description: {
            title: 'L’AGILITÉ EN MUTATION',
            content: "De l’eau a coulé sous les ponts depuis les premières tentatives d’équipes Scrum en France au début des années 2000. À cette époque, les équipes de développement cherchaient à transformer les chefs de projet technique en Scrum Master, les MOA en Product Owner. Aujourd’hui, la culture de l’agilité est ancrée dans les moeurs, les PO et facilitateurs sont recrutés pour ces métiers. Le résultat est flagrant dans nos organisations : le management visuel, l’esprit d’équipe, la démarche d’amélioration continue sont maintenant des acquis pour de nombreuses équipes. Les méthodes agiles sont arrivées à maturité et les équipes sont potentiellement efficaces. Potentiellement seulement, car le travail accompli jusqu’ici n’a optimisé qu’un maillon. Le développement n’est plus le goulot d’étranglement de la chaîne de valeur de la production logicielle. L’étape suivante consiste à considérer le processus de production logicielle dans son ensemble. Nous constatons une propagation de l’agilité aux interfaces des équipes de réalisation : vers le métier et vers les équipes de production."
        }
    },
    {
        file: 'techtrends-xebia-craft.pdf',
        date: '09/2014',
        packshot:'packshot-craft.jpg',
        summary: [
            {
                title: 'INITIER',
                content: [
                    "Alignez les visions de tous les participants du projet sur la notion de qualité logicielle",
                    "Entretenez une équipe de craftsmen passionnés et impliqués"
                ]
            },
            {
                title: 'CONSTRUIRE',
                content: [
                    "Favorisez la communication au sein de l'équipe",
                    "Laissez votre équipe choisir ses bons outils",
                    "Encouragez un environnement propice à la réalisation d'un code propre"
                ]
            },
            {
                title: 'ENTRETENIR',
                content: [
                    "Aménagez des temps d'échange et de partage",
